            ...
            <div style={{
                ...
                <div className={`${styles.stepInner} ${styles.step0}`}>
                    <div className={`${styles.innerLeftWrapper}`}>
                        ...
                        <h2>Enter Address</h2>
                        <div className={`${styles.horWrapper}`}>
                            <input type="text" placeholder="ex. your office area" className={`${styles.input} ${styles.smallInput}`} onChange={(e) => {setAddress(e.target.value)}}/>
                            <button className={`${styles.meetupButton}`} onChange={handleAddressChange}>Enter</button>
                        </div>
                ...
                <div className={`${styles.stepInner} ${styles.step0}`}>
                    <div className={`${styles.innerLeftWrapper}`}>
                        <h1>Set <span className={`${styles.hl}`}>reminders</span> for <span className={`${styles.hl}`}>recurring</span> meals</h1>
                        <p className={`${styles.p}`}>We’ll send your group a notification when it’s time to vote on a restaurant!</p>
